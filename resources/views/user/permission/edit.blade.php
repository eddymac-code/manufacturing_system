            ...
            <div class="p-2 text-gray-700">
                <form action="{{ route('edit-permission', $permission) }}" method="post">
                    ...
                    <div class="w-full p-1">
                        ...
                        border-red-500 @enderror" value="{{ $permission->name }}">
                    ...
                    <div class="w-full p-1">
                        ...
                        border-red-500 @enderror">{{ $permission->description }}</textarea>
                    ...
                    <button type="submit" class="px-4 py-3 bg-blue-600 text-white rounded-lg">Update Permission</button>
                </form>
            </div>
        </div>
    </div>
