                    ...
                    <div class="mt-2">
                        ...
                        <div class="flex flex-row">
                            ...
                            <div class="w-full p-1">
                                ...
                                <input type="text" name="unique_no" id="unique_no" value="{{ $unique }}" disabled 
                            ...
                            <div class="w-full p-1">
                                ...
                                border-red-500 @enderror" value="{{ old('mobile') }}">
                        ...
                        <div class="flex flex-row">
                            ...
                            <div class="w-full p-1">
                                ...
                                <input type="text" name="city" id="city" placeholder="Date of birth" 
                    ...
                    <div class="mt-2">
                        ...
                        <div class="flex flex-row">
                            <div class="w-full p-1">
                                ...
                                border-red-500 @enderror" value="{{ old('business_name') }}">
