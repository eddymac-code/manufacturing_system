<div class="sidenav-1" id="sidenav-main">
    <a href="#"><i class="fa-solid fa-computer"></i> Dashboard <i class="fa-solid fa-caret-right"></i></a>
    <a href="#" onclick="expand()"><i class="fa-solid fa-building"></i> Branches <i class="menu-arrow fa-solid fa-caret-right"></i></a>
    ...
    <a href="#" onclick="expand()"><i class="fa-solid fa-users"></i> Users <i class="menu-arrow fa-solid fa-caret-right"></i></a>
    <div class="content-menu">
        <a href="">Go</a>
        <a href="">Go</a>
        <a href="">Go</a>
